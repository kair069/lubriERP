...
# Datos de inventario con variables adicionales
data = {
...
# Modelo Random Forest para predecir demanda
def entrenar_modelo():
...
def chatbot_respuesta(pregunta):
    ...
    for producto_limpio, producto_original in productos_normalizados.items():
        if any(palabra in producto_limpio for palabra in pregunta_limpia.split()):
    ...
    return {
        ...
        "demanda_estimada": demanda_futura,
